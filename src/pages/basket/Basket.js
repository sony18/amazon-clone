  ...
  return (
    <div className="basket">
      <div className="basket__left">
        <p className="basket__advert">
          Advert Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit,
          unde!
        </p>
        ...
        {selectBasketTotalItem(basket) > 0 && (
          <div className="basket__left-subtotal">
            <p>
              Subtotal{" "}
              <span className="basket__left-figure">
                (
                <CurrencyFormat
                  displayType={"text"}
                  ...
                  prefix={"£"}
                  value={selectBasketTotalAmount(basket)}
                />
                )
              </span>
            </p>
