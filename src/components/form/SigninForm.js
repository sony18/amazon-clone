		...
		<>
			<div className="signin">
				...
				<form className="signin__form">
					...
					<small>
						By signing in you agree to test this Amazon-clone signinpage
						<span className="signin__form-condition">
							Conditions of testing app.
						</span>
						trial amazon site clone
					</small>
					<p className="signin__form-help">
						{" "}
						<ArrowRightIcon />
						Need help ?
					</p>
